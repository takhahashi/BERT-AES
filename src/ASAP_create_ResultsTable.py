...
def main(cfg: DictConfig):
    ...
    table_idx_name = ['reg', 'mul_reg', 'class', 'mul_class', 'mix', 'mul_mix', 'gp', 'gp_spectralnorm']#'exp_score', 'mul_exp_score', 'weighted_epx_score']
    utype_path_name = ['simple_reg_acc', 'ense_reg_acc', 'simple_class_acc', 'ense_class_acc', 'mix_acc', 'ense_mix_acc', 'GP_acc', 'GP_spectralnorm_acc']#'mix_expected_score_acc', 'ense_mix_expected_score_acc', 'mix_weighted_exp_score_acc']
