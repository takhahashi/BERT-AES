...
def main():
    ...
    utypes = ['mix', 'mix_mul', 'mix_scale_only', 'mix_mul_scale_only']
    ###roc_auc###
    roc_dic = {}
    for utype in utypes:
        roc_dic[utype] = []
    ...
    table_idx_name = ['mix', 'mul_mix', 'mix_scale_only', 'mix_mul_scale_only']
    utype_path_name = ['mix_acc', 'ense_mix_acc', 'mix_acc_scale_only', 'ense_mix_acc_scale_only']
