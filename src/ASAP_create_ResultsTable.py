...
def main(cfg: DictConfig):
    ...
    u_idx_name = ['reg', 'mul_reg', 'class', 'mul_class', 'mix', 'mul_mix', 'trust_score', 'gp', 'gp_spectral']
    ...
    utypes = ['simplevar', 'reg_mul', 'MP', 'class_mul_MP', 'mix', 'mix_mul', 'mix_expected_score', 'mix_weighted_exp_score', 'class_trust_score', 'GP', 'GP_spectral']#'mix_mul_expected_score', 'mix_weighted_exp_score']
    ###roc_auc###
    roc_dic = {}
    ...
    table_idx_name = ['reg', 'mul_reg', 'class', 'mul_class', 'mix', 'mul_mix', 'gp', 'gp_spectral']#'exp_score', 'mul_exp_score', 'weighted_epx_score']
    utype_path_name = ['simple_reg_acc', 'ense_reg_acc', 'simple_class_acc', 'ense_class_acc', 'mix_acc', 'ense_mix_acc', 'GP_acc', 'GP_spectral_acc']#'mix_expected_score_acc', 'ense_mix_expected_score_acc', 'mix_weighted_exp_score_acc']
